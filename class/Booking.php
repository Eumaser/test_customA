          ...
          <section class="content">
            <div class="box box-success">
              <div class="box-header with-border">
                ...
                <button type = "button" class="btn btn-primary pull-right" style = 'width:150px;' onclick = "window.location.href='booking.php'">Search</button>
                <?php if(getWindowPermission($_SESSION['m'][$_SESSION['empl_id']],'create')){?>
                <button type = "button" class="btn btn-primary pull-right" style = 'width:150px;margin-right:10px;' onclick = "window.location.href='booking.php?action=createForm'">Create New</button>
                <?php }?>
              </div>
...
<!--                        <div class="form-group">
                        ...
                        <div class="form-group">
                          ...
                          <div class="col-sm-3">
                           <select class="form-control select2" id="book_service_type" name="book_service_type" style = 'width:100%' <?php if($view == 1){echo "disabled"; }?>>
          ...
          <div class="row">
            <div class="col-xs-12">
              <div class="box">
                ...
                <?php if(getWindowPermission($_SESSION['m'][$_SESSION['empl_id']],'create')){?>
                <button class="btn btn-primary pull-right"  onclick = "window.location.href='booking.php?action=createForm'">Create New + </button>
