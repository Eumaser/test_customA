...
class Empl {
    ...
    public function getInputForm($action){
        ...
        $this->locationCrtl = $this->select->getLocationSelectCtrl($this->empl_outlet);
          ...
          <section class="content">
            <div class="box box-success">
              <div class="box-header with-border">
                <h3 class="box-title"><?php if($this->empl_id > 0){ echo "Update User";}else{ echo "Create New User";}?></h3>
        ...
        $("#empl_form").validate({
            ignore:":not(:visible)",
                  ...
                  messages:
                  {
                      ...
                      empl_outlet:
                      {
                        required: "Please choose your working location."        
                      },
                      empl_mobile:
                      {
...
<!--              <label for="empl_levegroup" class="col-sm-2 control-label">Employee Leave Group</label>
        ...
        <div class="form-group">
            <label for="empl_mobile" class="col-sm-2 control-label">Mobile <?php echo $mandatory;?></label>
            <div class="col-sm-3">
        ...
        <div class="form-group">
            <label for="empl_outlet" class="col-sm-2 control-label">Working Location <?php echo $mandatory;?></label>
            <div class="col-sm-3">
        ...
        <div class="form-group">
          ...
          <div class="col-sm-9">
                <textarea id="editor1" rows="10" cols="80" class="form-control" name="empl_remark" placeholder="Description"><?php echo $this->empl_remark;?></textarea>
                  ...
                  <table id="empl_table" class="table table-bordered table-hover">
                    <thead>
                      <tr>
                        ...
                        <th style = 'width:8%'>Working Location</th>
                    ...
                    <tbody>
                    <?php   
                      $sql = "SELECT empl.*,gp.group_code,location.location_title
                              FROM db_empl empl 
                              INNER JOIN db_group gp ON gp.group_id = empl.empl_group
                              LEFT JOIN db_location location ON location.location_id = empl.empl_outlet
                              WHERE empl.empl_id > 0 AND empl.empl_status = '1'
                              ORDER BY empl.insertDateTime";
                      $query = mysql_query($sql);
                      $i = 1;
                      while($row = mysql_fetch_array($query)){
                    ?>
