...
class Booth {
                  ...
                  <div class="box-body">
                      ...
                      <div class="nav-tabs-custom">
                        <ul class="nav nav-tabs">
                          ...
                          <li tab = "files" class="tab_header <?php if($this->current_tab == "files"){ echo 'active';}?>" ><a href="#files" data-toggle="tab">Files</a></li>
  ...
  <body class="hold-transition skin-blue sidebar-mini">
    ...
    //edr insert the file upload form here
    public function getFileUploads(){?>
      ...
      <div class="box-body table-responsive">
              ...
              <div class="form-group">
                  ...
                  <input style="margin-left:19%;"  data-toggle="tooltip" title="Please upload .doc .docx .pdf .xlsx or .xls" type="file" name="files[]" id="file_file" type="file" onchange="makeFileList();" multiple/><br>
