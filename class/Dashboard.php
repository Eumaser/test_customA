              ...
              <div class="box box-solid">
                ...
                <div class="box-body">
                  ...
                  <div id="external-events">
                    <div class="external-event bg-green" style="background-color:#0a5d0a !important; cursor: context-menu;">Booking Confirm</div>
                    <div class="external-event bg-light-blue" style="background-color:#0088ff !important; cursor: context-menu;">Booking Pending</div>
                    <div class="external-event bg-red" style="background-color:#FF0000 !important; cursor: context-menu;">Booking Rejected</div>
                    <div class="external-event bg-yellow" style="background-color:#fdb648 !important; cursor: context-menu;">Booking Cancel</div>
                  </div>
                </div><!-- /.box-body -->
              </div><!-- /. box -->
            </div><!-- /.col -->
