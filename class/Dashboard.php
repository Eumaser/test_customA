          ...
          <div class="row">
            ...
            <div class="col-md-2">
              <div class="box box-solid">
                <div class="box-header with-border">
                    <h4 class="box-title">Color Define</h4>
                </div>
                <div class="box-body">
                  <!-- the events -->
                  <div id="external-events">
                    <div class="external-event bg-green" style="background-color:#0a5d0a !important; cursor: context-menu;">Appointment Confirm</div>
                    <div class="external-event bg-light-blue" style="background-color:#0088ff !important; cursor: context-menu;">Appointment Pending</div>
                    <div class="external-event bg-red" style="background-color:#FF0000 !important; cursor: context-menu;">Appointment Rejected</div>
                    <div class="external-event bg-yellow" style="background-color:#fdb648 !important; cursor: context-menu;">Appointment Cancel</div>
                  </div>
                </div><!-- /.box-body -->
              </div><!-- /. box -->
            </div><!-- /.col -->
...
//                        $data[$i]['end'] = $row['appointment_date']." ".$row['appointment_end_time'];                                           
                        ...
                        }else if($row['appointment_confirm'] == "2"){
                            $data[$i]['backgroundColor'] = "#FF0000";
                        }else if($row['appointment_confirm'] == "3"){
